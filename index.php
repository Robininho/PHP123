      ...
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">
              <?php
              $km = 1; // initialisation d'une variable
              $km = 3;
              $km = 125;
              echo $km; // affichage du nom
              ?>
          </p>Robin Halberda 19
          </div>
        </div>
      ...
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">
              <?php
              $name = 'Robin'; // initialisation d'une variable
              echo $name; // affichage du nom
              ?>
            </p>
          </div>
        </div>
      ...
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <p class="card-text">
              <?php
              $firstname = 'Robin'; // initialisation des variables
              $lastname = 'Halberda';
              $age = '19';
              echo $firstname.' '.$lastname.' '.$age; // affichage du nom
              ?>
            </p>
          </div>
        </div>
